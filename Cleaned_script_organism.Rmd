...
test5 <- tax.abund(tabletempsub, otu2=NULL, rank = "p", drop.unclassified = TRUE, top = NULL, count = FALSE, mode = "percent")
...
write.table(insectITSsubset$data, file=paste(abundTablesPath, "Om.insectAbund.table.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
  
write.table(insectITSsubset$meta, file=paste(abundTablesPath, "Om.insectAbund.meta.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
...
write.table(RotorodITSsubset$data, file=paste(abundTablesPath, "Om.RotorodAbund.table.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
  
write.table(RotorodITSsubset$meta, file=paste(abundTablesPath, "Om.RotorodAbund.meta.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
...
write.table(SporeITSsubset$data, file=paste(abundTablesPath, "Om.SporeAbund.table.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
  
write.table(SporeITSsubset$meta, file=paste(abundTablesPath, "Om.SporeAbund.meta.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
...
write.table(SoilITSsubset$data, file=paste(abundTablesPath, "Om.SoilAbund.table.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
  
write.table(SoilITSsubset$meta, file=paste(abundTablesPath, "Om.SoilAbund.meta.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
