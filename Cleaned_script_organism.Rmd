...
# Open file-handle to get ready to make the raref curve:
  png(filename=paste(groupTaxaPath, "ITS", ".gr.abund.ki.png", sep = ""),
      width = 3000, height = 500, units = "px")


group.abundance.meta(data=(list(data=tabletemp)), rank="k", top = 10, count =  FALSE, drop.unclassified = TRUE, cex.x = 10, main = "OTU abundance at the Kingdom level", meta = metatemp)
