...
names(myvec) <- "Province"
 ...
 # Open file-handle to get ready to make the png graph:
png(filename=paste(pcoaDir, "Om", "PCOA.disteuc.standNorm.png", sep = ""),
      width = 1200, height = 1000, units = "px")

pcoa.plot(data = tabletemp, is.OTU = TRUE, meta = metatemp, factors = "Province", rank = NULL, stand.method = "normalize", dist.method = "euclidean", sample.labels = FALSE, top = 5, ellipse = 1, main = "PCOA by Trap Type for Oomycetes", ggplot2 = FALSE, bw = FALSE)
...
pcoa.plot(data = tabletemp, is.OTU = TRUE, meta = metatemp, factors = "TrapType", rank = NULL, stand.method = "hellinger", dist.method = "bray", sample.labels = FALSE, top = 5, ellipse = FALSE, main = "PCOA by Trap Type for Oomycetes", ggplot2 = TRUE, bw = FALSE)
...
pcoa.plot(data = tabletemp, is.OTU = TRUE, meta = metatemp, factors = "TrapType", rank = NULL, stand.method = "hellinger", dist.method = "jaccard", sample.labels = FALSE, top = 5, ellipse = FALSE, main = "PCOA by Trap Type for Oomycetes", ggplot2 = TRUE, bw = FALSE)
...
pcoa.plot(data = tabletemp, is.OTU = TRUE, meta = metatemp, factors = (myvec), rank = NULL, stand.method = "hellinger", dist.method = "jaccard", sample.labels = FALSE, top = 5, ellipse = FALSE, main = "PCOA by Trap Type for Phytophthora", ggplot2 = FALSE, bw = FALSE)

# Close the png graph file handle:
  dev.off()   
  
 # Open file-handle to get ready to make the png graph:
png(filename=paste(pcoaDir, "Phy", "PCOA.distEuc.standNorm.png", sep = ""),
      width = 1200, height = 1000, units = "px")

pcoa.plot(data = tabletemp, is.OTU = TRUE, meta = metatemp, factors = (myvec), rank = NULL, stand.method = "normalize", dist.method = "euclidean", sample.labels = FALSE, top = 5, ellipse = FALSE, main = "PCOA by Trap Type for Phytophthora", ggplot2 = FALSE, bw = FALSE)
