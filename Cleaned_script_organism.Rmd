...
geoDir <- paste(dataAnPath, "geographics", sep ="")
dir.create(geoDir,
           showWarnings = TRUE,
           recursive    = FALSE)

geoDirsamsize <- paste(dataAnPath, "geographics/samplingsize/", sep ="")
dir.create(geoDirsamsize,
           showWarnings = TRUE,
           recursive    = FALSE)
...
metatemp <-  read.table(paste(dataAnPath, "Om.meta.tsv", sep = ""),
                      sep = "\t", header = TRUE, dec = ".", comment.char = "", quote = "", stringsAsFactors = TRUE,
                      as.is = TRUE)
...
sample.locations(tabletemp, otu2 = NULL, meta = metatemp, zoom=3, source = "google", lat.col = "Latitude", long.col = "Longitude", labels = "Description")
...
sample.sites(meta = metatemp, siteID = "City",  zoom=3, lat = "Latitude", lon = "Longitude")
