...
tabletemp <- read.table(paste(taxabunDir, "ITS.taxab.table.tsv", sep = ""),
                      sep = "\t", header = TRUE, dec = ".", comment.char = "", quote = "", stringsAsFactors = TRUE,
                      as.is = TRUE, check.names = FALSE)
#tabletemp$row.names <- NULL if not using tXfilled tables you need it
...
pcoa.plot(data = tabletemp, meta = metatemp, rank = NULL, stand.method = "standardize", dist.method = "bray", top = 15, main = "PCOA of fungi at the family level", factors = "TrapType", ggplot2 =TRUE, is.OTU =FALSE)
