...
pcoa.plot(data = tabletemp, is.OTU = TRUE, meta = metatemp, factors = myvec, rank = NULL, stand.method = "normalize", dist.method = "euclidean", sample.labels = FALSE, top = 20, ellipse = FALSE, main = "PCOA by Trap Type for Oomycetes", ggplot2 = TRUE, bw = TRUE)
