...
# Open file-handle to get ready to make the png graph:
png(filename=paste(pcoaDir, "Om", ".pcoa.family.disteucstandnorm.png", sep = ""),
      width = 1200, height = 1000, units = "px")

pcoa.plot(data = tabletemp, is.OTU = TRUE, meta = metatemp, factors = (myvec), rank = NULL, stand.method = "normalize", dist.method = "euclidean", sample.labels = FALSE, top = 5, ellipse = FALSE, main = "PCOA by Trap Type for Oomycetes", ggplot2 = FALSE, bw = FALSE)
