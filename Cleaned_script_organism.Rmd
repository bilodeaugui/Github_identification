...
#without lures
  # Open file-handle to get ready to make the png graph:
  png(filename=paste(EvenPlotPath, "ITS", ".Shannon.Evenness2.png", sep = ""),
...
#no lure  
# Open file-handle to get ready to make the png graph:
  png(filename=paste(DivPlotPath, "ITS", ".Shannon.True.Div2.png", sep = ""),
      width = 500, height = 400, units = "px")
...
# Open file-handle to get ready to make the png graph:
  png(filename=paste(DivPlotPath, "ITS", ".Species.nb.2.png", sep = ""),
      width = 500, height = 400, units = "px")
...
#without lures
  # Open file-handle to get ready to make the png graph:
  png(filename=paste(EvenPlotPath, "Om", ".Shannon.Evenness2.png", sep = ""),
      width = 500, height = 400, units = "px")
...
#without lures
# Open file-handle to get ready to make the png graph:
  png(filename=paste(DivPlotPath, "Om", ".Shannon.True.Div2.png", sep = ""),
      width = 500, height = 400, units = "px")
...
# Open file-handle to get ready to make the png graph:
  png(filename=paste(DivPlotPath, "Om", ".Species.nb.2.png", sep = ""),
      width = 500, height = 400, units = "px")
...
#nolure
  # Open file-handle to get ready to make the png graph:
  png(filename=paste(EvenPlotPath, "Phy.nsp", ".Shannon.Evenness2.png", sep = ""),
      width = 500, height = 400, units = "px")
...
# Open file-handle to get ready to make the png graph:
  png(filename=paste(DivPlotPath, "Phy.nsp", ".Shannon.True.Div2.png", sep = ""),
      width = 500, height = 400, units = "px")
...
# Open file-handle to get ready to make the png graph:
  png(filename=paste(DivPlotPath, "Phy.nsp", ".Species.nb.2.png", sep = ""),
      width = 500, height = 400, units = "px")
