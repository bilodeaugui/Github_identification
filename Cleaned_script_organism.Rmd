...
#ITSsubInscets <- subset(metatemp, "TrapType" == Insect)

insectITSsubset <- data.subset(list(data=tabletemp), meta= metatemp, factors = c("TrapType"), values = c("Insect"), and = FALSE)

write.table(insectITSsubset$data, file=paste(RanksPath, "ITS.insectAbund.table.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)
  
write.table(insectITSsubset$meta, file=paste(RanksPath, "ITS.insectAbund.table.tsv", sep = ""),
                               append    = FALSE,
                               sep       = "\t",
                               row.names = FALSE,
                               quote=FALSE)  
