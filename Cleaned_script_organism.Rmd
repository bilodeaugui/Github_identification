...
# Open file-handle to get ready to make the raref curve:
  png(filename=paste(groupTaxaPath, "ITS", ".gr.abund.ge.png", sep = ""),
      width = 10000, height = 500, units = "px")


group.abundance.meta(data=(list(data=tabletemp)), rank="g", top = 10, count =  FALSE, drop.unclassified = TRUE, cex.x = 8, main = "OTU abundance at the Kingdom level", meta = metatemp, meta.factor = c("TrapType", "Lure"))
