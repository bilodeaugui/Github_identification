...
for(i in 1:nrow(metadataMasterTax)){
  temp <-  read.table(paste(metadataMasterTax$taxPath[8], metadataMasterTax$taxName[8], sep = ""),
                      sep = "\t", header = TRUE, dec = ".", comment.char = "", quote = "", stringsAsFactors = TRUE,
  ...
  png(filename=paste(pathDataAn, "otuRecap/", metadataMasterTax$ShortName[8], ".otuRecap.png", sep = ""), 
       width = 800, height = 600, units = "px")
  
 OTU.recap(data = list(data = temp), ranks=ranks, brewer.pal="colors")
              dev.off()
