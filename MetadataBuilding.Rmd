...
# Open file-handle to get ready to make the png graph:
  png(filename=paste(diversityPath, "ITS", ".group.diversity.png", sep = ""),
      width = 2000, height = 3000, units = "px")

group.diversity(list(data=tabletemp), metatemp, factors = c("TrapType"), indices = c("sim_even", "shan_even"), diversity.info=TRUE, facet=TRUE, x.axis="TrapType", compare="Lure")
