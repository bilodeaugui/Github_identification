...
Create diversity directory and path. List your datasets for diversity index. This adds a column in a new diversity metadata file.
```{r}
...
for(i in 1:nrow(metadataMasterTax)){
  ...
  data=list(trans2, all.names=TRUE)
  temp2 <- OTU.diversity(data=trans2, meta=temp2)
  }
  
  
  }
 # list_df = lapply(trans2, get)
  #transList <-list(trans2, check.names = FALSE)
  #transList <- setNames(transList, trans2)
 # data=list(data=trans2)
 ...
 # [1] TRUE
  ...
  temp$diversity <- temp2$diversity
