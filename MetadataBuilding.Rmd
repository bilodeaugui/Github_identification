...
group.diversity(list(data=tabletemp), metatemp, factors = c("TrapType"), indices = "evenness", diversity.info=TRUE, facet=TRUE, x.axis="TrapType", compare="Lure", facet=NULL, )
